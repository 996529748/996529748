...
var axios$1 = createInstance$1(defaults);
axios$1.Axios = Axios;
...
function createLoadingComponent(options) {
  ...
  const data2 = reactive(__spreadProps(__spreadValues({}, options), {
    originalPosition: "",
    originalOverflow: "",
    visible: false
  }));
  ...
  const elLoadingComponent = {
    ...
    setup() {
      return () => {
        ...
        const spinnerText = data2.text ? h("p", { class: "el-loading-text" }, [data2.text]) : void 0;
        return h(Transition, {
  ...
  return __spreadProps(__spreadValues({}, toRefs(data2)), {
    setText,
    remvoeElLoadingChild,
    close,
    handleAfterLeave,
...
class customInterceptors {
  constructor(config) {
    ...
    this.showLoading = (_a = config.showLoading) != null ? _a : DEFAULT_LOADING;
...
export { customInterceptors as default };
